-- This part is created by David Dursteler
...
-- There is also a section at the end where the connections are added.


-- The following was auto-generated by doing 
...
-- Back to David Dursteler's code (well, based on https://guacamole.apache.org/doc/gug/jdbc-auth.html and https://stackoverflow.com/questions/25969/insert-into-values-select-from)
INSERT INTO guacamole_connection (connection_name, protocol) VALUES ('kde_desktop', 'vnc');
INSERT INTO guacamole_connection_parameter (connection_id, parameter_name, parameter_value) 
  SELECT connection_id, 'hostname', 'kde_desktop' FROM guacamole_connection WHERE connection_name = 'kde_desktop' AND parent_id IS NULL;
INSERT INTO guacamole_connection_parameter (connection_id, parameter_name, parameter_value)
  SELECT connection_id, 'port', 5900 FROM guacamole_connection WHERE connection_name = 'kde_desktop' AND parent_id IS NULL;
INSERT INTO guacamole_connection_parameter (connection_id, parameter_name, parameter_value)
  SELECT connection_id, 'password', 'password' FROM guacamole_connection WHERE connection_name = 'kde_desktop' AND parent_id IS NULL;